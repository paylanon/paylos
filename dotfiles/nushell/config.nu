...
# -- CUSTOM THEMES --
use ~/nu-themes/black-metal-gorgoroth.nu
...
$env.config = {
    ...
    color_config: (black-metal-gorgoroth) # if you want a more interesting theme, you can replace the empty record with `$dark_theme`, `$light_theme` or another custom record
    use_grid_icons: true
