...
⠀⠀⠀  ⠀⠀⠀⠀⠀⠀⠀       ⠳⡂⠈⢻⣽⣾⣿⣿⣿⣿⣽⣿⣿⣿⣯⡇⠑⡅⣽⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀")
          ...
          (when recover-session
            ;; (delete-char -2)
            (insert-text-button " [Recover Last Session] "
          ...
          (center-line) (insert "\n")
          (insert (propertize
                   "Copyright (C) 2024 Free Software Foundation, Inc." 'face 'shadow))
          (center-line) (insert "\n")

          (insert (propertize "Press Any Key to Start" 'face 'bold))
          (center-line) (insert "\n")
...
(defun splash-screen-fade-to (about duration)
  "Fade out current frame for duration and goes to command-or-buffer"
  (interactive)
